    ...
    return(
        <div className="min-h-screen flex flex-col bg-white transition-colors">
            ...
            <div className='text-sm md:text-base font-medium text-emerald-800/70 p-5'>
                ...
                <p className='pt-2'>Desde ya estamos recibiendo sus pagos anticipados en la cuenta de Bancolombia 24688135326 o desde cualquier otro banco con la llave bre-b jcquitiang@hotmail.com, recuerda enviar junto con el comprobante de pago, los nombres de las personas que están haciendo el aporte, al whatsapp 3156215590 de Mónica Quitián</p>
                <p className='font-bold pt-4'>Recibimos también pagos con tu tarjeta de crédito, por favor comunicarte por whatsapp al 3156215590 de Mónica Quitián, para darte las instrucciones, de forma múy fácil y segura</p>
            </div>
            <Footer />
        </div>
    );
